...
namespace NeverQ_01
{
    public partial class GetNumberPage : PhoneApplicationPage
    {
        //TranslateTransform dragTraslation = new TranslateTransform();
        ...
        public GetNumberPage()
        {
            ...
            CurrentNo.Text = "22";   //先post當下的狀態做initialize
            ExpectTime.Text = "12";
